...
public class MinStrategyTest
{
    ...
    public void DoSpecificAggregate_ShouldReturnMinValueOfSpecificColumnOfRows_WhnParameterAreRowsAndColumn(
        decimal expected , List<DataRow> rows , DataColumn column)
    {
        // Arrange
        var strategy = new MinStrategy();
        // Act
    ...
    public static IEnumerable<object[]> RowsAndColumn()
    {
        ...
        yield return [12, firstRows, firstTable.Columns["Score"]!];
        ...
        yield return [0, secondRows, secondTable.Columns["Score"]!];
        ...
        yield return [14, thirdRows, thirdTable.Columns["Score"]!];
