...
public class SumStrategyTest
{
    ...
    public void DoSpecificAggregate_ShouldReturnSumValueOfSpecificColumnOfRows_WhenParameterAreRowsAndColumn(
        decimal expected , List<DataRow> rows , DataColumn column)
    {
        // Arrange
        var strategy = new SumStrategy();
        // Act
    ...
    public static IEnumerable<object[]> RowsAndColumn()
    {
        ...
        yield return [83, firstRows, firstTable.Columns["Score"]!];
        ...
        secondRows[2].ItemArray = ["Mamad", "Math", "0"];
        secondRows[3].ItemArray = ["Jason", "Math", "16"];
        secondRows[4].ItemArray = ["Mary", "Math", "14"];
        yield return [67, secondRows, secondTable.Columns["Score"]!];
        ...
        yield return [87, thirdRows, thirdTable.Columns["Score"]!];
