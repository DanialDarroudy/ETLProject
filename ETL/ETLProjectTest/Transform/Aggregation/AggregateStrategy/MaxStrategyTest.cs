...
public class MaxStrategyTest
{
    ...
    public void DoSpecificAggregate_ShouldReturnMaxValueOfSpecificColumnOfRows_WhnParameterAreRowsAndColumn(
        decimal expected , List<DataRow> rows , DataColumn column)
    {
        // Arrange
        var strategy = new MaxStrategy();
        // Act
    ...
    public static IEnumerable<object[]> RowsAndColumn()
    {
        ...
        yield return [20, secondRows, secondTable.Columns["Score"]!];
        ...
        yield return [20, thirdRows, thirdTable.Columns["Score"]!];
